...
def send_email(send_from, send_to, subject, text, files=None):
    ...
    smtp.starttls()
    smtp.login(send_from, 'uoqdechfzonrwdgq')
...
if __name__ == "__main__":
    ...
    send_email('arkohnelsonemmanuel@gmail.com', ['nelsenimma@gmail.com'], 'Jobs Posting', 'Please find attached a list of job postings to this email', files=['remote_jobs.xls'])