...
def addTask():
    time.sleep(2)
    DRIVER.find_element(By.XPATH, value="//textrea[@aria-label='To Do']/ancestor::div/descendant::div[@class='card-composer-container js-card-composer-container']/child::a").click()
